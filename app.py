...
def home_page():
    ...
    # check if roll starts with 25E...
    join_math_group = (len(rollno) > 2 and rollno[2].upper() == "E")

    return render_template("home.html", rollno=rollno, join_math_group=join_math_group)
